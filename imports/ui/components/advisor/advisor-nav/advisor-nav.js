...
export class AdvisorNavigation extends React.Component {
  ...
  render() {
    return <div>
              {/*<AppBar 
                title={<Link to="/advisor/home" style={styles.titleLink}>Advisor Dashboard</Link>}
